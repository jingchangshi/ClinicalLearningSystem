...
class Score(Base):
    ...
    evaluation_mode: Mapped[str] = mapped_column(String(30), nullable=False, default="rule_fallback")
    provider: Mapped[str | None] = mapped_column(String(50), nullable=True)
    model: Mapped[str | None] = mapped_column(String(100), nullable=True)
    prompt_version: Mapped[str] = mapped_column(String(50), nullable=False, default="case-evaluation-v1")
    rubric_version: Mapped[str] = mapped_column(String(50), nullable=False, default="case-rubric-v1")
    evaluator_version: Mapped[str] = mapped_column(String(50), nullable=False, default="hybrid-v1")
    ...
    evaluation_detail_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
